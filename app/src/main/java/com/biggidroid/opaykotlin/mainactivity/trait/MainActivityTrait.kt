package com.biggidroid.opaykotlin.mainactivity.trait
...
import com.biggidroid.opaykotlin.pages.UserPage
...
import com.biggidroid.opaykotlin.pages.AddCash
import com.biggidroid.opaykotlin.viewmodel.AppViewModel
import com.google.android.material.appbar.AppBarLayout


open class MainActivityTrait : AppCompatActivity(), NestedScrollView.OnScrollChangeListener {
    ...
    private lateinit var add_cash_layout: CardView
...
//        viewPager.adapter = adapter2
    ...
    private fun setOnClickListener() {
        ...
        //add_cash_layout
        add_cash_layout.setOnClickListener {
            //goto add cash page
            val intent = Intent(this, AddCash::class.java)
            //fade out and fade in animation
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                // Apply activity transition
                val transition = TransitionInflater.from(this)
                    .inflateTransition(R.transition.fade_slide_transition)
