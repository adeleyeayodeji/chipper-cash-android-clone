...
class AddCash : Fragment() {
    //binding
    private var _binding: ActivityAddCashBinding? = null
    ...
    override fun onCreateView(
        ...
        //inflate layout
        _binding = ActivityAddCashBinding.inflate(inflater, container, false)
        //return root
        return binding.root
    }
    ...
    private fun setOnClickListener() {
        binding.closeIconAddcashPage.setOnClickListener {
